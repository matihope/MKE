...
namespace mk {
	...
	public:
		...
		virtual void render2dContext(const Drawable2D& drawable, DrawContext context) const = 0;

	protected:
		void defaultRender2D(const Drawable2D& drawable, DrawContext context) const;
	};
	...
	public:
		...
		virtual void render3dContext(const Drawable3D& drawable, DrawContext context) const = 0;

	protected:
		void defaultRender3D(const Drawable3D& drawable, DrawContext context) const;
	};
